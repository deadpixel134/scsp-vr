...
internal static class UiText
{
    ...
    private static Dictionary<string, string> Korean() => new()
    {
        ...
        ["Locomotion"] = "스틱 이동",
        ["LocomotionEnabled"] = "스틱 이동 사용",
        ["LocomotionHand"] = "스틱 이동 손 (반대 손은 시야 회전)",
        ["LocomotionSpeed"] = "이동 속도 (m/s)",
        ["WorldDrag"] = "월드 드래그 이동",
        ["WorldDragEnabled"] = "월드 드래그 사용",
        ["WorldDragActivation"] = "드래그 활성화 버튼",
        ["WorldDragLeftGrip"] = "왼손 Grip",
        ["WorldDragLeftTrigger"] = "왼손 Trigger",
        ["WorldDragRightGrip"] = "오른손 Grip",
        ["WorldDragRightTrigger"] = "오른손 Trigger",
        ["WorldDragTracking"] = "움직임 추적 손",
        ["WorldDragTrackLeft"] = "왼손 추적",
        ["WorldDragTrackRight"] = "오른손 추적",
        ["WorldDragNotice"] = "입력 충돌",
        ["WorldDragPanelConflict"] = "선택한 Grip은 손 패널 토글이 우선하므로 월드 드래그를 시작하지 않습니다.",
        ["ViewTurn"] = "시야 회전",
        ["ViewTurnEnabled"] = "스틱 시야 회전 사용",
    ...
    private static Dictionary<string, string> English() => new()
    {
        ...
        ["LocomotionEnabled"] = "Enable thumbstick movement",
        ["LocomotionHand"] = "Movement hand (other hand turns view)",
        ["LocomotionSpeed"] = "Movement speed (m/s)",
        ["WorldDrag"] = "World-drag locomotion",
        ["WorldDragEnabled"] = "Enable world dragging",
        ["WorldDragActivation"] = "Drag activation buttons",
        ["WorldDragLeftGrip"] = "Left Grip",
        ["WorldDragLeftTrigger"] = "Left Trigger",
        ["WorldDragRightGrip"] = "Right Grip",
        ["WorldDragRightTrigger"] = "Right Trigger",
        ["WorldDragTracking"] = "Motion-tracking hands",
        ["WorldDragTrackLeft"] = "Track left hand",
        ["WorldDragTrackRight"] = "Track right hand",
        ["WorldDragNotice"] = "Input conflict",
        ["WorldDragPanelConflict"] = "The hand-panel toggle takes priority, so the selected Grip cannot start world dragging.",
        ["ViewTurn"] = "View turning",
        ["ViewTurnEnabled"] = "Enable thumbstick view turning",
    ...
    private static Dictionary<string, string> Japanese() => new()
    {
        ...
        ["Locomotion"] = "スティック移動",
        ["LocomotionEnabled"] = "スティック移動を使用",
        ["LocomotionHand"] = "移動側（反対側は視点回転）",
        ["LocomotionSpeed"] = "移動速度 (m/s)",
        ["WorldDrag"] = "ワールドドラッグ移動",
        ["WorldDragEnabled"] = "ワールドドラッグを使用",
        ["WorldDragActivation"] = "ドラッグ開始ボタン",
        ["WorldDragLeftGrip"] = "左手 Grip",
        ["WorldDragLeftTrigger"] = "左手 Trigger",
        ["WorldDragRightGrip"] = "右手 Grip",
        ["WorldDragRightTrigger"] = "右手 Trigger",
        ["WorldDragTracking"] = "動きを追跡する手",
        ["WorldDragTrackLeft"] = "左手を追跡",
        ["WorldDragTrackRight"] = "右手を追跡",
        ["WorldDragNotice"] = "入力の競合",
        ["WorldDragPanelConflict"] = "ハンドパネルの切替が優先されるため、選択したGripではワールドドラッグを開始できません。",
        ["ViewTurn"] = "視点回転",
        ["ViewTurnEnabled"] = "スティック視点回転を使用",
        ["ViewTurnMode"] = "視点回転方式",
